...
public class AbbreviationParser<T extends Enum<T>>
{
	public static class AmbigueAbbreviationException extends RuntimeException
	{
		...
		public AmbigueAbbreviationException(@Nullable final String message)
		{
			super(message);
		}
	}
	...
	public static class InvalidAbbreviationException extends RuntimeException
	{
		...
		public InvalidAbbreviationException(@Nullable final String message)
		{
			super(message);
		}
	}
	...
	public AbbreviationParser(@Nonnull final Class<T> clazz)
	{
		this.clazz = clazz;
	}

	@Nonnull
	public T getEnumFor(@Nullable final String prefix)
	{
		...
		if (result == null)
		{
			throw new InvalidAbbreviationException("Could not find any " + clazz.getSimpleName() + " for abbreviation \"" + prefix + "\"");
		}
